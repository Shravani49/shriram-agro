...
const mediaItems = [
  ...
  {
    n: "07",
    title: "Sakal AgroVon - Composting from Waste to Receive a Major Boost",
    link: "https://drive.google.com/file/d/19Th_v8_E-f58JLQKBztlf3yOd77adDaA/view?usp=sharing",
  },
    ...
    <div style={{ fontFamily: "'Playfair Display', Georgia, serif", background: "#FAFAF8", color: "#1a1a1a" }}>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .founder-linkedin svg { width: 22px; height: 22px; fill: white; }
        .founder-linkedin:hover { transform: scale(1.1); box-shadow: 0 10px 28px rgba(0,0,0,0.35); }
        ...
        /* SHARED LAYOUT */
        .wrap { max-width: 1100px; margin: 0 auto; padding: 88px 40px; }
        .sh { display: flex; align-items: center; gap: 16px; margin-bottom: 48px; }
        .sh-tag {
          font-family: 'Lato', sans-serif;
          font-size: 30px;
          font-weight: 800;
        ...
        .pos-card { background: #fff; padding: 36px 30px; }
        .pos-org {
          font-family: 'Lato', sans-serif;
          font-size: 24px;
          font-weight: 700;
        ...
        .pos-role { font-size: 24px; font-weight: 600; color: #1C3829; margin-bottom: 10px; line-height: 1.3; }
        .pos-desc { font-family: 'Lato', sans-serif; font-size: 20px; font-weight: 500; color: #111; line-height: 1.75; }
        ...
        .prod-card:hover { border-color: #C9A84C; box-shadow: 0 6px 24px rgba(28,56,41,.07); }
        .prod-abbr { font-family: 'Lato', sans-serif; font-size: 18px; font-weight: 1000; letter-spacing: 2.5px; color: #C9A84C; margin-bottom: 12px; }
        .prod-name { font-size: 24px; font-weight: 600; color: #1C3829; margin-bottom: 8px; line-height: 1.3; }
        .prod-desc { font-family: 'Lato', sans-serif; font-size: 18px; font-weight: 900; color: #999; line-height: 1.7; }
        ...
        .edu-t { font-size: 20px; font-weight: 600; color: #1C3829; line-height: 1.4; }
        .edu-s { font-family: 'Lato', sans-serif; font-size: 12px; color: #C9A84C; font-weight: 700; letter-spacing: 0.5px; margin-top: 3px; }

        /* PUBLICATIONS */
        .pub-root-inner { font-family: 'DM Sans', sans-serif; }
        .pub-eyebrow { display: flex; align-items: center; gap: 14px; margin-bottom: 12px; }
        .pub-eyebrow-dot { width: 6px; height: 6px; border-radius: 50%; background: #B8973E; flex-shrink: 0; }
        .pub-eyebrow-label {
        ...
        .pub-wrap { max-width: 1400px; margin: 0 auto; padding: 88px 40px; }
        ...
        .media-card:hover { border-color: #c9b87a; background: #fff; box-shadow: 0 4px 20px rgba(28,56,41,0.07); }
        .media-card-num { font-size: 24px; color: #1C3829; font-weight: 600; font-family: 'Playfair Display', serif; }
        .media-card-title { font-family: 'Playfair Display', serif; font-size: 24px; font-weight: 600; color: #1C3829; line-height: 1.5; margin: 0; }
        .media-card-cta { display: flex; align-items: center; gap: 6px; font-family: 'DM Sans', sans-serif; font-size: 16px; font-weight: 600; color: #B8973E; letter-spacing: 0.05em; margin-top: auto; }
        ...
        .art-card-source { font-family: 'DM Sans', sans-serif; font-size: 24px; font-weight: 600; letter-spacing: 0.14em; text-transform: uppercase; color: #B8973E; margin-bottom: 10px; }
        .art-card-num { display: inline-block; font-size: 30px; color: #bbb; margin-right: 8px; font-family: 'Playfair Display', serif; }
        .art-card-title { font-family: 'Playfair Display', serif; font-size: 24px; font-weight: 600; color: #1C3829; line-height: 1.45; margin: 0 0 10px 0; text-decoration: none; display: block; }
        .art-card-desc { font-family: 'DM Sans', sans-serif; font-size: 18px; color: #777; line-height: 1.7; margin: 0; }
        .art-cta { display: inline-flex; align-items: center; gap: 7px; font-family: 'DM Sans', sans-serif; font-size: 18px; font-weight: 600; color: #1C3829; text-decoration: none; letter-spacing: 0.06em; white-space: nowrap; margin-top: 4px; transition: color 0.2s, gap 0.2s; }
        ...
        .author-badge:hover { border-color: #B8973E; box-shadow: 0 2px 12px rgba(184,151,62,0.12); }
        .author-badge-dot { width: 8px; height: 8px; border-radius: 50%; background: #4CAF50; flex-shrink: 0; }
        .author-badge strong { color: #1C3829; font-weight: 600; }

        /* Footer */
        .foot { background: #111; padding: 26px 80px; display: flex; justify-content: space-between; align-items: center; }
        .foot-n { font-size: 15px; font-weight: 600; color: #fff; }
        .foot-m { font-family: 'Lato', sans-serif; font-size: 11px; letter-spacing: 1.5px; color: rgba(255,255,255,.25); text-transform: uppercase; }
        ...
        @media (max-width: 560px) {
          .founder-linkedin { top: auto !important; bottom: 24px !important; right: 16px !important; width: 46px !important; height: 46px !important; }
          .hero { flex-direction: column; min-height: auto; }
          .hero-left { padding: 44px 20px 40px !important; }
          .tag { font-size: 13px !important; letter-spacing: 2px !important; margin-bottom: 16px !important; }
          .hero-name { font-size: 32px !important; margin-bottom: 12px !important; }
          .hero-role { font-size: 16px !important; margin-bottom: 24px !important; }
          .hero-bio { font-size: 16px !important; line-height: 1.7 !important; margin-bottom: 32px !important; }
          .hero-stats {
            gap: 20px !important;
          ...
          .stat-l { font-size: 11px !important; letter-spacing: 0.5px !important; }
          .hero-right { width: 100% !important; height: auto !important; background: #1C3829; }
          .hero-right img { width: 100% !important; height: auto !important; object-fit: contain !important; object-position: center center !important; display: block !important; filter: brightness(0.9) saturate(0.85) !important; }
          .hero-fade { background: linear-gradient(to bottom, #1C3829 0%, transparent 15%) !important; }
          .hero-badge { font-size: 12px !important; padding: 8px 12px !important; bottom: 12px !important; right: 12px !important; }
          .wrap { padding: 44px 16px !important; }
          .pub-wrap { padding: 44px 16px !important; }
          .sh { margin-bottom: 28px !important; gap: 10px !important; }
          .sh-tag { font-size: 14px !important; letter-spacing: 2px !important; white-space: normal !important; }
          ...
          .art-card { grid-template-columns: 1fr !important; padding: 22px 0 !important; gap: 14px !important; }
          ...
          .author-badge { font-size: 14px !important; padding: 10px 16px !important; margin-bottom: 28px !important; flex-wrap: nowrap !important; display: flex !important; align-items: flex-start !important; gap: 8px !important; width: 100% !important; border-radius: 14px !important; }
          .author-badge span { flex: 1 !important; line-height: 1.5 !important; }
          .author-badge svg { flex-shrink: 0 !important; margin-top: 3px !important; }
          .foot { padding: 20px 16px !important; flex-direction: column !important; gap: 6px !important; text-align: center !important; }
        ...
        <div className="hero-left">
          ...
          <div className="hero-stats a4">
            ...
            <div>
              ...
              <div className="stat-l">Global Associations</div>
            </div>
          </div>
        </div>
      ...
      <div style={{ background: '#fff' }}>
        <div className="pub-wrap pub-root-inner">
          ...
          <a href="https://wikifarmer.com/library/en/author/rahul" target="_blank" rel="noopener noreferrer" className="author-badge">
            ...
            {articles.map((a) => (
              <div key={a.n} className="art-card">
                <div>
                  ...
                  <a href={a.link} target="_blank" rel="noopener noreferrer" className="art-card-title">{a.title}</a>
                  <p className="art-card-desc">{a.desc}</p>
                </div>
                <a href={a.link} target="_blank" rel="noopener noreferrer" className="art-cta">Read Article <ArrowRight /></a>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="media-grid">
            {mediaItems.map((m) => (
              <a key={m.n} href={m.link} target="_blank" rel="noopener noreferrer" className="media-card">
                <div className="media-card-num">{m.n}</div>
                <p className="media-card-title">{m.title}</p>
                <div className="media-card-cta">View Feature <ArrowRight /></div>
              </a>
            ))}
          </div>
        </div>
