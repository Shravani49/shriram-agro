    ...
    <div id="about" className="bg-[#F1F3E0]">
      ...
      <style>{`
        @media (max-width: 767px) {
          ...
          .about-hero-h1 { font-size: clamp(2rem, 9vw, 4rem) !important; }
          .about-hero-sub { font-size: 1rem !important; }
        }
        ...
        @media (max-width: 767px) {
          ...
          .mv-card { padding: 14px 16px !important; }
        }

        @media (max-width: 767px) {
          .team-grid { grid-template-columns: 1fr !important; }
          .team-card { padding: 20px 16px !important; }
          .founder-card { padding: 24px 16px !important; }
          .founder-card h3 { font-size: 1.4rem !important; }
          .founder-card p { font-size: 1rem !important; }
        }
        ...
        @media (max-width: 767px) {
          ...
          .cta-h2 { font-size: clamp(1.8rem, 7vw, 3rem) !important; }
        ...
        @media (max-width: 767px) {
          .about-company-section { padding-top: 48px !important; padding-bottom: 48px !important; }
          .about-company-content { padding-left: 16px !important; padding-right: 16px !important; }
        }

        @media (max-width: 767px) {
          .mission-section { padding-top: 32px !important; padding-bottom: 32px !important; }
          .mission-header h2 { font-size: 1.4rem !important; }
          .mission-grid-wrapper { padding-left: 4px !important; padding-right: 4px !important; }
        }

        @media (max-width: 767px) {
          .stats-section { padding-top: 48px !important; padding-bottom: 48px !important; }
          .stats-content { padding-left: 16px !important; padding-right: 16px !important; }
        }

        @media (max-width: 767px) {
          .team-section { padding-top: 48px !important; padding-bottom: 48px !important; }
          .team-header h2 { font-size: 2rem !important; }
          .team-header-label { font-size: 0.85rem !important; letter-spacing: 0.1em !important; }
        }
      `}</style>
  ...
  Shriram Agro Industries
      ...
      <section className="about-company-section relative py-28 overflow-hidden">
        <div className="absolute inset-0">
          <img src="/images/compost-facility.png" alt="Industrial Composting Facility" className="w-full h-full object-cover" />
        </div>
      ...
      <section className="mission-section py-10 sm:py-14 bg-white">
        <div className="mx-auto px-4 sm:px-6">
          ...
          <div className="mission-header text-center mb-6 sm:mb-10">
            <div className="inline-block px-3 py-1 bg-[#F1F3E0] rounded-full mb-3">
              <span className="text-xs font-medium text-[#7d5835] tracking-wide">OUR FOUNDATION</span>
            </div>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-light text-[#2a2a2a]">
              Mission & Vision
            </h2>
          </div>

          <div className="mv-grid mission-grid-wrapper grid md:grid-cols-2 gap-4 mx-auto px-2 sm:px-10 max-w-2xl">

            {/* Vision Card */}
            <div className="mv-card group relative overflow-hidden bg-gradient-to-br from-[#7baa67] via-[#27773a] to-[#09451f] p-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-500 hover:-translate-y-1">
              <div className="relative">
                <div className="w-8 h-8 bg-[#E5D9B6] rounded-lg flex items-center justify-center mb-3 group-hover:scale-105 transition-transform duration-500">
                  <svg className="w-4 h-4 text-[#1F3D2B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                  </svg>
                </div>
                <h3 className="text-sm font-bold mb-2 text-white">Our Vision</h3>
            ...
            {/* Mission Card */}
            <div className="mv-card group relative overflow-hidden bg-gradient-to-br from-[#E5D9B6] to-[#d4c8a5] p-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-500 hover:-translate-y-1">
              <div className="relative">
                <div className="w-8 h-8 bg-[#7d5835] rounded-lg flex items-center justify-center mb-3 group-hover:scale-105 transition-transform duration-500">
                  <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <h3 className="text-sm font-bold mb-2 text-[#2a2a2a]">Our Mission</h3>
      ...
      <section className="stats-section relative py-8 sm:py-12 text-white overflow-hidden">
        <div className="absolute inset-0">
          <img src="/images/background.png" alt="Sustainable Compost Facility" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="stats-content relative max-w-[1200px] mx-auto px-4 sm:px-10">
          <div className="grid grid-cols-3 gap-3 sm:gap-8 text-center">
            <div className="group">
              <div className="text-xl sm:text-3xl md:text-4xl font-light mb-1 bg-gradient-to-br from-white to-[#E5D9B6] bg-clip-text text-transparent inline-block">22+</div>
              <div className="text-[10px] sm:text-sm text-white/90 leading-tight">Years of expertise in sustainable agriculture</div>
            </div>
            <div className="group">
              <div className="text-xl sm:text-3xl md:text-4xl font-light mb-1 bg-gradient-to-br from-white to-[#E5D9B6] bg-clip-text text-transparent inline-block">100%</div>
              <div className="text-[10px] sm:text-sm text-white/90 leading-tight">Organic, chemical-free soil solutions</div>
            </div>
            <div className="group">
              <div className="text-xl sm:text-3xl md:text-4xl font-light mb-1 bg-gradient-to-br from-white to-[#E5D9B6] bg-clip-text text-transparent inline-block">Global</div>
              <div className="text-[10px] sm:text-sm text-white/90 leading-tight">Impact across India and abroad</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cta-section relative py-16 sm:py-20 md:py-32 bg-white overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="cta-buttons flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center w-full">
            <Link
              href="/contact"
              className="px-6 py-2.5 text-sm font-medium bg-[#7d5835] text-white rounded-full hover:bg-[#6a4a2d] transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-block text-center"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-2.5 text-sm font-medium border-2 border-[#7d5835] text-[#7d5835] rounded-full hover:bg-[#7d5835] hover:text-white transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg inline-block text-center"
            >
              Download Brochure
            </a>
          </div>
