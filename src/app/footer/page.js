          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:info@shriramagro.com" className="text-white/80 hover:text-[#F2C94C] transition-colors duration-200 text-xl">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+911234567890" className="text-white/80 hover:text-[#F2C94C] transition-colors duration-200 text-xl">
                  +91 9921881000
                </a>
              </li>
            </ul>
